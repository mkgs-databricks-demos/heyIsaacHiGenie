import { __commonJS, __esm, __require, __toESM } from "./chunk-BMwS5_Mx.js";
import { basename } from "node:path";
import { createReadStream, promises } from "node:fs";

//#region node_modules/web-streams-polyfill/dist/ponyfill.es2018.js
var require_ponyfill_es2018 = __commonJS({ "node_modules/web-streams-polyfill/dist/ponyfill.es2018.js"(exports, module) {
	/**
	* @license
	...
	*/
	(function(global$1, factory) {
		...
		function promiseResolvedWith(value) {
			return newPromise((resolve$1) => resolve$1(value));
		}
		...
		*/
		...
		function ReadableStreamReaderGenericRelease(reader) {
			const stream = reader._ownerReadableStream;
			if (stream._state === "readable") defaultReaderClosedPromiseReject(reader, new TypeError(`Reader was released and can no longer be used to monitor the stream's closedness`));
		...
		function defaultReaderClosedPromiseInitialize(reader) {
			reader._closedPromise = newPromise((resolve$1, reject) => {
				reader._closedPromise_resolve = resolve$1;
		...
		*/
		class ReadableStreamDefaultReader {
			...
			*/
			read() {
				...
				let resolvePromise;
				let rejectPromise;
				const promise = newPromise((resolve$1, reject) => {
		...
		function ReadableStreamDefaultReaderRelease(reader) {
			...
			const e$1 = new TypeError("Reader was released");
			ReadableStreamDefaultReaderErrorReadRequests(reader, e$1);
		}
		...
		*/
		...
		function ReadableByteStreamControllerPullInto(controller, view, min, readIntoRequest) {
			...
			if (controller._queueTotalSize > 0) {
				...
				if (controller._closeRequested) {
					const e$1 = new TypeError("Insufficient bytes to fill elements in the given buffer");
					ReadableByteStreamControllerError(controller, e$1);
					readIntoRequest._errorSteps(e$1);
					return;
				}
		...
		function ReadableByteStreamControllerRespondInternal(controller, bytesWritten) {
			...
			if (state === "closed") ReadableByteStreamControllerRespondInClosedState(controller, firstDescriptor);
		...
		*/
		...
		function ReadableStreamBYOBReaderRelease(reader) {
			ReadableStreamReaderGenericRelease(reader);
			const e$1 = new TypeError("Reader was released");
			ReadableStreamBYOBReaderErrorReadIntoRequests(reader, e$1);
		}
		...
		*/
		...
		function defaultWriterClosedPromiseInitialize(writer) {
			writer._closedPromise = newPromise((resolve$1, reject) => {
				writer._closedPromise_resolve = resolve$1;
		...
		function defaultWriterReadyPromiseInitialize(writer) {
			writer._readyPromise = newPromise((resolve$1, reject) => {
				writer._readyPromise_resolve = resolve$1;
		...
		*/
		function createPolyfill() {
			const ctor = function DOMException$1(message, name) {
		...
		function ReadableStreamPipeTo(source, dest, preventClose, preventAbort, preventCancel, signal) {
			...
			return newPromise((resolve$1, reject) => {
				let abortAlgorithm;
				if (signal !== void 0) {
					abortAlgorithm = () => {
		...
		*/
		...
		function ReadableStreamDefaultTee(stream, cloneForBranch2) {
			...
			const cancelPromise = newPromise((resolve$1) => {
				resolveCancelPromise = resolve$1;
			});
		...
		function ReadableStreamFromIterable(asyncIterable) {
			...
			function pullAlgorithm() {
				...
				return transformPromiseWith(nextPromise, (iterResult) => {
					...
					if (done) ReadableStreamDefaultControllerClose(stream._readableStreamController);
					else {
		...
		*/
		class TransformStream {
			constructor(rawTransformer = {}, rawWritableStrategy = {}, rawReadableStrategy = {}) {
				...
				const startPromise = newPromise((resolve$1) => {
					startPromise_resolve = resolve$1;
				});
		...
		function TransformStreamSetBackpressure(stream, backpressure) {
			...
			stream._backpressureChangePromise = newPromise((resolve$1) => {
				stream._backpressureChangePromise_resolve = resolve$1;
			});
			stream._backpressure = backpressure;
		}
		/**
		...
		*/
		...
		function TransformStreamDefaultSinkAbortAlgorithm(stream, reason) {
			...
			controller._finishPromise = newPromise((resolve$1, reject) => {
				controller._finishPromise_resolve = resolve$1;
...
var require_streams = __commonJS({ "node_modules/fetch-blob/streams.cjs"() {
	/* c8 ignore start */
...
var init_fetch_blob = __esm({ "node_modules/fetch-blob/index.js"() {
	POOL_SIZE = 65536;
	_Blob = class Blob$1 {
...
var init_file = __esm({ "node_modules/fetch-blob/file.js"() {
	init_fetch_blob();
...
var init_esm_min = __esm({ "node_modules/formdata-polyfill/esm.min.js"() {
	init_fetch_blob();
	init_file();
...
var require_node_domexception = __commonJS({ "node_modules/node-domexception/index.js"(exports, module) {
...
var stat, BlobDataItem;
var init_from = __esm({ "node_modules/fetch-blob/from.js"() {
	init_file();
	init_fetch_blob();
	({stat} = promises);
...
//#endregion
export { FormData, fetch_blob_default, file_default, formDataToBlob, init_esm_min, init_fetch_blob, init_from };