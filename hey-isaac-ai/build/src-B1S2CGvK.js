import { __esm } from "./chunk-B_1218FY.js";
import { FormData, fetch_blob_default, file_default, formDataToBlob, init_esm_min, init_fetch_blob, init_from } from "./from-BO_mz74d.js";
...
var dist_default;
var init_dist = __esm({ "node_modules/data-uri-to-buffer/dist/index.js"() {
...
var FetchBaseError;
var init_base = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/errors/base.js"() {
...
var FetchError;
var init_fetch_error = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/errors/fetch-error.js"() {
	init_base();
...
var init_is = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/utils/is.js"() {
...
var init_body = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/body.js"() {
	init_fetch_blob();
	init_esm_min();
	init_fetch_error();
	init_base();
	...
	Body = class {
		...
		*/
		...
		async formData() {
			...
			const { toFormData } = await import("./multipart-parser-CMMbZ5Gz.js");
...
var init_headers = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/headers.js"() {
...
var init_is_redirect = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/utils/is-redirect.js"() {
...
var init_response = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/response.js"() {
	init_headers();
	init_body();
	init_is_redirect();
...
var getSearch;
var init_get_search = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/utils/get-search.js"() {
	getSearch = (parsedURL) => {
...
var init_referrer = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/utils/referrer.js"() {
...
var init_request = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/request.js"() {
	init_headers();
	init_body();
	init_is();
	init_get_search();
...
var AbortError;
var init_abort_error = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/errors/abort-error.js"() {
	init_base();
...
*/
async function fetch(url$1, options_) {
		...
		request_.on("response", (response_) => {
			...
			if (isRedirect(response_.statusCode)) {
				...
				switch (request.redirect) {
					...
					default: return reject(new TypeError(`Redirect option '${request.redirect}' is not a valid value of RequestRedirect`));
				}
			}
...
var init_src = __esm({ "node_modules/google-auth-library/node_modules/node-fetch/src/index.js"() {
	init_dist();
	init_body();
	init_response();
	init_headers();
