...
import { require_picocolors } from "./picocolors-BtD5UNhW.js";

//#region node_modules/postcss/lib/tokenize.js
var require_tokenize = __commonJS({ "node_modules/postcss/lib/tokenize.js"(exports, module) {
	...
	module.exports = function tokenizer$2(input, options = {}) {
...
var require_stringify = __commonJS({ "node_modules/postcss/lib/stringify.js"(exports, module) {
...
var require_node = __commonJS({ "node_modules/postcss/lib/node.js"(exports, module) {
...
var require_comment = __commonJS({ "node_modules/postcss/lib/comment.js"(exports, module) {
	let Node$4 = require_node();
	var Comment$5 = class extends Node$4 {
		constructor(defaults) {
			super(defaults);
			this.type = "comment";
		}
...
var require_declaration = __commonJS({ "node_modules/postcss/lib/declaration.js"(exports, module) {
	...
	var Declaration$5 = class extends Node$3 {
		get variable() {
...
var require_container = __commonJS({ "node_modules/postcss/lib/container.js"(exports, module) {
	...
	var Container$8 = class Container$8 extends Node$2 {
		get first() {
		...
		normalize(nodes, sample) {
			if (typeof nodes === "string") nodes = cleanSource(parse$5(nodes).nodes);
...
var require_util = __commonJS({ "node_modules/source-map-js/lib/util.js"(exports) {
	...
	*/
	var normalize = lruMemoize(function normalize$1(aPath) {
		...
		var isAbsolute$1 = exports.isAbsolute(path);
		var parts = [];
		var start = 0;
		var i = 0;
		while (true) {
...
var require_previous_map = __commonJS({ "node_modules/postcss/lib/previous-map.js"(exports, module) {
 ...
 /* c8 ignore next 2 */
	...
	var PreviousMap$2 = class {
		...
		consumer() {
			if (!this.consumerCache) this.consumerCache = new SourceMapConsumer$2(this.json || this.text);
...
var require_root = __commonJS({ "node_modules/postcss/lib/root.js"(exports, module) {
...
var require_fromJSON = __commonJS({ "node_modules/postcss/lib/fromJSON.js"(exports, module) {
	...
	function fromJSON$2(json, inputs) {
		...
		if (defaults.nodes) defaults.nodes = json.nodes.map((n) => fromJSON$2(n, inputs));
		if (defaults.source) {
	...
	var MapGenerator$2 = class {
		...
		applyPrevMaps() {
			for (let prev of this.previous()) {
				...
				let root$1 = prev.root || dirname(prev.file);
				let map;
...
var require_parser = __commonJS({ "node_modules/postcss/lib/parser.js"(exports, module) {
...
var require_parse = __commonJS({ "node_modules/postcss/lib/parse.js"(exports, module) {
...
var require_no_work_result = __commonJS({ "node_modules/postcss/lib/no-work-result.js"(exports, module) {
	...
	var NoWorkResult$1 = class {
		...
		constructor(processor, css, opts) {
			...
			this._map = void 0;
			let str = stringify$2;
			this.result = new Result$2(this._processor, void 0, this._opts);
			this.result.css = css;
			let self = this;
...
var require_processor = __commonJS({ "node_modules/postcss/lib/processor.js"(exports, module) {
...
var require_postcss = __commonJS({ "node_modules/postcss/lib/postcss.js"(exports, module) {
	...
	let Node$1 = require_node();
	let parse$1 = require_parse();
...
//#endregion
export { AtRule, Comment, Container, CssSyntaxError, Declaration, Document, Input, Node, Processor, Result, Root, Rule, Warning, atRule, comment, decl, document, fromJSON, list, parse, plugin, postcss_default, root, rule, stringify };