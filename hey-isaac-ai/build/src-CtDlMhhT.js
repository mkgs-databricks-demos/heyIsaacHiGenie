import { __esm } from "./chunk-BMwS5_Mx.js";
import { FormData, fetch_blob_default, file_default, formDataToBlob, init_esm_min, init_fetch_blob, init_from } from "./from-AJrodOP2.js";
	...
	Body = class {
		...
		*/
		...
		async formData() {
			...
			const { toFormData } = await import("./multipart-parser-KjWf0uom.js");
